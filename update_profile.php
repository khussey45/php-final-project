...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `ai_users` SET name = '$update_name', email = '$update_email',bio = '$update_bio' WHERE id = '$user_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `ai_users` SET image = '$update_image' WHERE id = '$user_id'") or die('query failed');
